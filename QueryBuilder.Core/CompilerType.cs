...
namespace QueryBuilder.Core
{
    public class CompilerType : IEquatable<CompilerType>
    {
        ...
        public static CompilerType Number => new CompilerType("int", TokenType.IntConstant);
        ...
        public static CompilerType Float => new CompilerType("float", TokenType.FloatConstant);
